...
func NewSecondServiceProcessor(handler SecondService) *SecondServiceProcessor {
	...
	self161 := &SecondServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self161.processorMap["blahBlah"] = &secondServiceProcessorBlahBlah{handler: handler}
	self161.processorMap["secondtestString"] = &secondServiceProcessorSecondtestString{handler: handler}
	return self161
}
...
func (p *SecondServiceProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	x162 := thrift.NewTApplicationException(thrift.UNKNOWN_METHOD, "Unknown function "+name)
...
func NewBlahBlahArgs() *BlahBlahArgs {
	return &BlahBlahArgs{}
}

func (p *BlahBlahArgs) Read(iprot thrift.TProtocol) error {
...
func (p *BlahBlahArgs) Write(oprot thrift.TProtocol) error {
...
func (p *BlahBlahArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("BlahBlahArgs(%+v)", *p)
}

type BlahBlahResult struct {
}

func NewBlahBlahResult() *BlahBlahResult {
	return &BlahBlahResult{}
}

func (p *BlahBlahResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return fmt.Errorf("%T read error: %s", p, err)
	}
	for {
...
func (p *BlahBlahResult) Write(oprot thrift.TProtocol) error {
...
func (p *BlahBlahResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("BlahBlahResult(%+v)", *p)
}
...
func NewSecondtestStringArgs() *SecondtestStringArgs {
	return &SecondtestStringArgs{}
}

func (p *SecondtestStringArgs) GetThing() string {
	return p.Thing
}
func (p *SecondtestStringArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return fmt.Errorf("%T read error: %s", p, err)
	}
	for {
...
func (p *SecondtestStringArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *SecondtestStringArgs) Write(oprot thrift.TProtocol) error {
...
func (p *SecondtestStringArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *SecondtestStringArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SecondtestStringArgs(%+v)", *p)
}
...
func NewSecondtestStringResult() *SecondtestStringResult {
	return &SecondtestStringResult{}
}

var SecondtestStringResult_Success_DEFAULT string

func (p *SecondtestStringResult) GetSuccess() string {
	if !p.IsSetSuccess() {
		return SecondtestStringResult_Success_DEFAULT
	}
	return *p.Success
}
func (p *SecondtestStringResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SecondtestStringResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return fmt.Errorf("%T read error: %s", p, err)
	}
	for {
...
func (p *SecondtestStringResult) ReadField0(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
...
func (p *SecondtestStringResult) Write(oprot thrift.TProtocol) error {
...
func (p *SecondtestStringResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *SecondtestStringResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SecondtestStringResult(%+v)", *p)
}
