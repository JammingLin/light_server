...
std::ostream& operator<<(std::ostream& out, const OldSchool& obj) {
  ...
  out << "OldSchool(";
  out << "im_int=" << to_string(obj.im_int);
  out << ", " << "im_str=" << to_string(obj.im_str);
  out << ", " << "im_big=" << to_string(obj.im_big);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Simple& obj) {
  using apache::thrift::to_string;
  out << "Simple(";
  out << "im_default=" << to_string(obj.im_default);
  out << ", " << "im_required=" << to_string(obj.im_required);
  out << ", " << "im_optional="; (obj.__isset.im_optional ? (out << to_string(obj.im_optional)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const OptionalDefault& obj) {
  using apache::thrift::to_string;
  out << "OptionalDefault(";
  out << "opt_int="; (obj.__isset.opt_int ? (out << to_string(obj.opt_int)) : (out << "<null>"));
  out << ", " << "opt_str="; (obj.__isset.opt_str ? (out << to_string(obj.opt_str)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Complex& obj) {
  using apache::thrift::to_string;
  out << "Complex(";
  out << "cp_default=" << to_string(obj.cp_default);
  out << ", " << "cp_required=" << to_string(obj.cp_required);
  out << ", " << "cp_optional="; (obj.__isset.cp_optional ? (out << to_string(obj.cp_optional)) : (out << "<null>"));
  out << ", " << "the_map=" << to_string(obj.the_map);
  out << ", " << "req_simp=" << to_string(obj.req_simp);
  out << ", " << "opt_simp="; (obj.__isset.opt_simp ? (out << to_string(obj.opt_simp)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const ManyOpt& obj) {
  using apache::thrift::to_string;
  out << "ManyOpt(";
  out << "opt1="; (obj.__isset.opt1 ? (out << to_string(obj.opt1)) : (out << "<null>"));
  out << ", " << "opt2="; (obj.__isset.opt2 ? (out << to_string(obj.opt2)) : (out << "<null>"));
  out << ", " << "opt3="; (obj.__isset.opt3 ? (out << to_string(obj.opt3)) : (out << "<null>"));
  out << ", " << "def4=" << to_string(obj.def4);
  out << ", " << "opt5="; (obj.__isset.opt5 ? (out << to_string(obj.opt5)) : (out << "<null>"));
  out << ", " << "opt6="; (obj.__isset.opt6 ? (out << to_string(obj.opt6)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const JavaTestHelper& obj) {
  using apache::thrift::to_string;
  out << "JavaTestHelper(";
  out << "req_int=" << to_string(obj.req_int);
  out << ", " << "opt_int="; (obj.__isset.opt_int ? (out << to_string(obj.opt_int)) : (out << "<null>"));
  out << ", " << "req_obj=" << to_string(obj.req_obj);
  out << ", " << "opt_obj="; (obj.__isset.opt_obj ? (out << to_string(obj.opt_obj)) : (out << "<null>"));
  out << ", " << "req_bin=" << to_string(obj.req_bin);
  out << ", " << "opt_bin="; (obj.__isset.opt_bin ? (out << to_string(obj.opt_bin)) : (out << "<null>"));
  out << ")";
  return out;
}
