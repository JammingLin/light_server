...
class ReverseOrderService_myMethod_args {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ReverseOrderService_myMethod_args& obj);
};
...
class ReverseOrderService_myMethod_pargs {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ReverseOrderService_myMethod_pargs& obj);
};
...
class ReverseOrderService_myMethod_result {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ReverseOrderService_myMethod_result& obj);
};
...
class ReverseOrderService_myMethod_presult {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ReverseOrderService_myMethod_presult& obj);
};
