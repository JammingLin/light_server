...
const char* MyStruct::ascii_fingerprint = "CFDB532B5050558FA19C643C996DAD13";
const uint8_t MyStruct::binary_fingerprint[16] = {0xCF,0xDB,0x53,0x2B,0x50,0x50,0x55,0x8F,0xA1,0x9C,0x64,0x3C,0x99,0x6D,0xAD,0x13};
...
std::ostream& operator<<(std::ostream& out, const MyStruct& obj) {
  ...
  out << "MyStruct(";
  out << "me2_2=" << to_string(obj.me2_2);
  out << ", " << "me3_n2=" << to_string(obj.me3_n2);
  out << ", " << "me3_d1=" << to_string(obj.me3_d1);
  out << ")";
  return out;
}
