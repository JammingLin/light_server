...
std::ostream& operator<<(std::ostream& out, const Doubles& obj) {
  ...
  out << "Doubles(";
  out << "nan=" << to_string(obj.nan);
  out << ", " << "inf=" << to_string(obj.inf);
  out << ", " << "neginf=" << to_string(obj.neginf);
  out << ", " << "repeating=" << to_string(obj.repeating);
  out << ", " << "big=" << to_string(obj.big);
  out << ", " << "tiny=" << to_string(obj.tiny);
  out << ", " << "zero=" << to_string(obj.zero);
  out << ", " << "negzero=" << to_string(obj.negzero);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const OneOfEach& obj) {
  ...
  out << ", " << "a_bite=" << to_string(obj.a_bite);
  out << ", " << "integer16=" << to_string(obj.integer16);
  out << ", " << "integer32=" << to_string(obj.integer32);
  out << ", " << "integer64=" << to_string(obj.integer64);
  out << ", " << "double_precision=" << to_string(obj.double_precision);
  out << ", " << "some_characters=" << to_string(obj.some_characters);
  out << ", " << "zomg_unicode=" << to_string(obj.zomg_unicode);
  out << ", " << "what_who=" << to_string(obj.what_who);
  out << ", " << "base64=" << to_string(obj.base64);
  out << ", " << "byte_list=" << to_string(obj.byte_list);
  out << ", " << "i16_list=" << to_string(obj.i16_list);
  out << ", " << "i64_list=" << to_string(obj.i64_list);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Nesting& obj) {
  using apache::thrift::to_string;
  out << "Nesting(";
  out << "my_bonk=" << to_string(obj.my_bonk);
  out << ", " << "my_ooe=" << to_string(obj.my_ooe);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const HolyMoley& obj) {
  ...
  out << "HolyMoley(";
  out << "big=" << to_string(obj.big);
  out << ", " << "contain=" << to_string(obj.contain);
  out << ", " << "bonks=" << to_string(obj.bonks);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Backwards& obj) {
  using apache::thrift::to_string;
  out << "Backwards(";
  out << "first_tag2=" << to_string(obj.first_tag2);
  out << ", " << "second_tag1=" << to_string(obj.second_tag1);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RandomStuff& obj) {
  using apache::thrift::to_string;
  out << "RandomStuff(";
  out << "a=" << to_string(obj.a);
  out << ", " << "b=" << to_string(obj.b);
  out << ", " << "c=" << to_string(obj.c);
  out << ", " << "d=" << to_string(obj.d);
  out << ", " << "myintlist=" << to_string(obj.myintlist);
  out << ", " << "maps=" << to_string(obj.maps);
  out << ", " << "bigint=" << to_string(obj.bigint);
  out << ", " << "triple=" << to_string(obj.triple);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Base64& obj) {
  ...
  out << ", " << "b2=" << to_string(obj.b2);
  out << ", " << "b3=" << to_string(obj.b3);
  out << ", " << "b4=" << to_string(obj.b4);
  out << ", " << "b5=" << to_string(obj.b5);
  out << ", " << "b6=" << to_string(obj.b6);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const CompactProtoTestStruct& obj) {
  ...
  out << "a_byte=" << to_string(obj.a_byte);
  out << ", " << "a_i16=" << to_string(obj.a_i16);
  out << ", " << "a_i32=" << to_string(obj.a_i32);
  out << ", " << "a_i64=" << to_string(obj.a_i64);
  out << ", " << "a_double=" << to_string(obj.a_double);
  out << ", " << "a_string=" << to_string(obj.a_string);
  out << ", " << "a_binary=" << to_string(obj.a_binary);
  out << ", " << "true_field=" << to_string(obj.true_field);
  out << ", " << "false_field=" << to_string(obj.false_field);
  out << ", " << "empty_struct_field=" << to_string(obj.empty_struct_field);
  out << ", " << "byte_list=" << to_string(obj.byte_list);
  out << ", " << "i16_list=" << to_string(obj.i16_list);
  out << ", " << "i32_list=" << to_string(obj.i32_list);
  out << ", " << "i64_list=" << to_string(obj.i64_list);
  out << ", " << "double_list=" << to_string(obj.double_list);
  out << ", " << "string_list=" << to_string(obj.string_list);
  out << ", " << "binary_list=" << to_string(obj.binary_list);
  out << ", " << "boolean_list=" << to_string(obj.boolean_list);
  out << ", " << "struct_list=" << to_string(obj.struct_list);
  out << ", " << "byte_set=" << to_string(obj.byte_set);
  out << ", " << "i16_set=" << to_string(obj.i16_set);
  out << ", " << "i32_set=" << to_string(obj.i32_set);
  out << ", " << "i64_set=" << to_string(obj.i64_set);
  out << ", " << "double_set=" << to_string(obj.double_set);
  out << ", " << "string_set=" << to_string(obj.string_set);
  out << ", " << "binary_set=" << to_string(obj.binary_set);
  out << ", " << "boolean_set=" << to_string(obj.boolean_set);
  out << ", " << "struct_set=" << to_string(obj.struct_set);
  out << ", " << "byte_byte_map=" << to_string(obj.byte_byte_map);
  out << ", " << "i16_byte_map=" << to_string(obj.i16_byte_map);
  out << ", " << "i32_byte_map=" << to_string(obj.i32_byte_map);
  out << ", " << "i64_byte_map=" << to_string(obj.i64_byte_map);
  out << ", " << "double_byte_map=" << to_string(obj.double_byte_map);
  out << ", " << "string_byte_map=" << to_string(obj.string_byte_map);
  out << ", " << "binary_byte_map=" << to_string(obj.binary_byte_map);
  out << ", " << "boolean_byte_map=" << to_string(obj.boolean_byte_map);
  out << ", " << "byte_i16_map=" << to_string(obj.byte_i16_map);
  out << ", " << "byte_i32_map=" << to_string(obj.byte_i32_map);
  out << ", " << "byte_i64_map=" << to_string(obj.byte_i64_map);
  out << ", " << "byte_double_map=" << to_string(obj.byte_double_map);
  out << ", " << "byte_string_map=" << to_string(obj.byte_string_map);
  out << ", " << "byte_binary_map=" << to_string(obj.byte_binary_map);
  out << ", " << "byte_boolean_map=" << to_string(obj.byte_boolean_map);
  out << ", " << "list_byte_map=" << to_string(obj.list_byte_map);
  out << ", " << "set_byte_map=" << to_string(obj.set_byte_map);
  out << ", " << "map_byte_map=" << to_string(obj.map_byte_map);
  out << ", " << "byte_map_map=" << to_string(obj.byte_map_map);
  out << ", " << "byte_set_map=" << to_string(obj.byte_set_map);
  out << ", " << "byte_list_map=" << to_string(obj.byte_list_map);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const SingleMapTestStruct& obj) {
  ...
  out << "i32_map=" << to_string(obj.i32_map);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const ReverseOrderStruct& obj) {
  ...
  out << "first=" << to_string(obj.first);
  out << ", " << "second=" << to_string(obj.second);
  out << ", " << "third=" << to_string(obj.third);
  out << ", " << "fourth=" << to_string(obj.fourth);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const TestUnion& obj) {
  ...
  out << ", " << "i32_field=" << to_string(obj.i32_field);
  out << ", " << "struct_field=" << to_string(obj.struct_field);
  out << ", " << "struct_list=" << to_string(obj.struct_list);
  out << ", " << "other_i32_field=" << to_string(obj.other_i32_field);
  out << ", " << "enum_field=" << to_string(obj.enum_field);
  out << ", " << "i32_set=" << to_string(obj.i32_set);
  out << ", " << "i32_map=" << to_string(obj.i32_map);
  out << ")";
  return out;
...
std::ostream& operator<<(std::ostream& out, const StructWithAUnion& obj) {
  ...
  out << "test_union=" << to_string(obj.test_union);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const PrimitiveThenStruct& obj) {
  ...
  out << "blah=" << to_string(obj.blah);
  out << ", " << "blah2=" << to_string(obj.blah2);
  out << ", " << "bw=" << to_string(obj.bw);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const StructWithASomemap& obj) {
  ...
  out << "somemap_field=" << to_string(obj.somemap_field);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const TupleProtocolTestStruct& obj) {
  ...
  out << "field1="; (obj.__isset.field1 ? (out << to_string(obj.field1)) : (out << "<null>"));
  out << ", " << "field2="; (obj.__isset.field2 ? (out << to_string(obj.field2)) : (out << "<null>"));
  out << ", " << "field3="; (obj.__isset.field3 ? (out << to_string(obj.field3)) : (out << "<null>"));
  out << ", " << "field4="; (obj.__isset.field4 ? (out << to_string(obj.field4)) : (out << "<null>"));
  out << ", " << "field5="; (obj.__isset.field5 ? (out << to_string(obj.field5)) : (out << "<null>"));
  out << ", " << "field6="; (obj.__isset.field6 ? (out << to_string(obj.field6)) : (out << "<null>"));
  out << ", " << "field7="; (obj.__isset.field7 ? (out << to_string(obj.field7)) : (out << "<null>"));
  out << ", " << "field8="; (obj.__isset.field8 ? (out << to_string(obj.field8)) : (out << "<null>"));
  out << ", " << "field9="; (obj.__isset.field9 ? (out << to_string(obj.field9)) : (out << "<null>"));
  out << ", " << "field10="; (obj.__isset.field10 ? (out << to_string(obj.field10)) : (out << "<null>"));
  out << ", " << "field11="; (obj.__isset.field11 ? (out << to_string(obj.field11)) : (out << "<null>"));
  out << ", " << "field12="; (obj.__isset.field12 ? (out << to_string(obj.field12)) : (out << "<null>"));
  out << ")";
  return out;
}
