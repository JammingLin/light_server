...
class OldSchool {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const OldSchool& obj);
};
...
class Simple {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Simple& obj);
};
...
class Tricky1 {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Tricky1& obj);
};
...
class Tricky2 {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Tricky2& obj);
};
...
class Tricky3 {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Tricky3& obj);
};
...
class OptionalDefault {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const OptionalDefault& obj);
};
...
class ManyOpt {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ManyOpt& obj);
};
...
class JavaTestHelper {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const JavaTestHelper& obj);
};
