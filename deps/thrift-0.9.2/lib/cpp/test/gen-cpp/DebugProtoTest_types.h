...
class Doubles {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Doubles& obj);
};
...
class OneOfEach {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const OneOfEach& obj);
};
...
class Bonk {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Bonk& obj);
};
...
class Nesting {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Nesting& obj);
};
...
class HolyMoley {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const HolyMoley& obj);
};
...
class Backwards {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Backwards& obj);
};
...
class Empty {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Empty& obj);
};
...
class Wrapper {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Wrapper& obj);
};
...
class RandomStuff {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const RandomStuff& obj);
};
...
class Base64 {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Base64& obj);
};
...
class CompactProtoTestStruct {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const CompactProtoTestStruct& obj);
};
...
class SingleMapTestStruct {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const SingleMapTestStruct& obj);
};
...
class ExceptionWithAMap : public ::apache::thrift::TException {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ExceptionWithAMap& obj);
};
...
class BlowUp {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const BlowUp& obj);
};
...
class ReverseOrderStruct {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ReverseOrderStruct& obj);
};
...
class StructWithSomeEnum {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const StructWithSomeEnum& obj);
};
...
class TestUnion {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const TestUnion& obj);
};
...
class TestUnionMinusStringField {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const TestUnionMinusStringField& obj);
};
...
class ComparableUnion {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ComparableUnion& obj);
};
...
class StructWithAUnion {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const StructWithAUnion& obj);
};
...
class PrimitiveThenStruct {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const PrimitiveThenStruct& obj);
};
...
class StructWithASomemap {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const StructWithASomemap& obj);
};
...
class BigFieldIdStruct {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const BigFieldIdStruct& obj);
};
...
class BreaksRubyCompactProtocol {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const BreaksRubyCompactProtocol& obj);
};
...
class TupleProtocolTestStruct {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const TupleProtocolTestStruct& obj);
};
