...
class Inherited_identity_args {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Inherited_identity_args& obj);
};
...
class Inherited_identity_pargs {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Inherited_identity_pargs& obj);
};
...
class Inherited_identity_result {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Inherited_identity_result& obj);
};
...
class Inherited_identity_presult {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Inherited_identity_presult& obj);
};
