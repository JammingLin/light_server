...
class ServiceForExceptionWithAMap_methodThatThrowsAnException_args {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ServiceForExceptionWithAMap_methodThatThrowsAnException_args& obj);
};
...
class ServiceForExceptionWithAMap_methodThatThrowsAnException_pargs {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ServiceForExceptionWithAMap_methodThatThrowsAnException_pargs& obj);
};
...
class ServiceForExceptionWithAMap_methodThatThrowsAnException_result {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ServiceForExceptionWithAMap_methodThatThrowsAnException_result& obj);
};
...
class ServiceForExceptionWithAMap_methodThatThrowsAnException_presult {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ServiceForExceptionWithAMap_methodThatThrowsAnException_presult& obj);
};
